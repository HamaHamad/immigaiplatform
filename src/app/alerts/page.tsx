...
export default async function AlertsPage() {
  ...
  const myVisaTypes = userCases.map((c: { visaCategory: string }) => c.visaCategory)
  ...
  const myAlerts    = annotated.filter((a: any) => a.affectsMe)
  const otherAlerts = annotated.filter((a: any) => !a.affectsMe)
